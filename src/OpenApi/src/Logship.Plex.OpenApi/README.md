...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IActivitiesApi>();
            GetServerActivitiesApiResponse apiResponse = await api.GetServerActivitiesAsync("todo");
            GetServerActivities200Response model = apiResponse.Ok();
        }
...
- How do I validate requests and process responses?
  Use the provided On and After methods in the Api class from the namespace Logship.Plex.OpenApi.Rest.DefaultApi.
...
- appName: Plex API
- appVersion: 0.0.1
- appDescription: Plex OpenAPI Spec 
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {96CE2B2F-D1DE-4833-AAED-EBDE8B81F303}
- packageName: Logship.Plex.OpenApi
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
