...
namespace Logship.Plex.OpenApi.Client
{
    ...
    /// </summary>
    /// <typeparam name="TType"></typeparam>
    public interface IRequestTimeout<TType> : IApiResponse
    {
        /// <summary>
        /// Deserializes the response if the response is RequestTimeout
        /// </summary>
        /// <returns></returns>
        TType RequestTimeout();

        /// <summary>
        /// Returns true if the response is RequestTimeout and the deserialized response is not null
        /// </summary>
        /// <param name="result"></param>
        /// <returns></returns>
        bool TryRequestTimeout([NotNullWhen(true)]out TType? result);
    }
